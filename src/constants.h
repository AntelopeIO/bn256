...
namespace bn256::constants {
        ...
        static const auto u = boost::multiprecision::int128_t("4965661367192848881");
        ...
        static const auto order = boost::multiprecision::int128_t("21888242871839275222246405745257275088548364400416034343698204186575808495617");
