...
namespace bn256 {
    ...
    static const auto u = boost::multiprecision::uint128_t("4965661367192848881");
    ...
    static const auto Order = boost::multiprecision::uint128_t("21888242871839275222246405745257275088548364400416034343698204186575808495617");

    // P is a prime over which we form a basic field: 36u⁴+36u³+24u²+6u+1.
    static const boost::multiprecision::uint128_t P = boost::multiprecision::uint128_t("21888242871839275222246405745257275088696311157297823662689037894645226208583");

    // p2 is p, represented as little-endian 64-bit words.
    inline constexpr uint64_array_4_t p2 = {0x3c208c16d87cfd47, 0x97816a916871ca8d, 0xb85045b68181585d, 0x30644e72e131a029};

    // np is the negative inverse of p, mod 2^256.
    inline constexpr uint64_array_4_t np = {0x87d20782e4866389, 0x9ede7d651eca6ac9, 0xd8afcbd01833da80, 0xf57a22b791888c6b};
    ...
    inline constexpr gfP2 xiToPMinus1Over6 = {
    ...
    inline constexpr gfP2 xiToPMinus1Over3 = {
    ...
    inline constexpr gfP2 xiToPMinus1Over2 = {
    ...
    inline constexpr gfP xiToPSquaredMinus1Over3 = {0x3350c88e13e80b9c, 0x7dce557cdb5e56b9, 0x6001b4b8b615564a, 0x2682e617020217e0};

    // xiTo2PSquaredMinus2Over3 is ξ^((2p²-2)/3) where ξ = i+9 (a cubic root of unity, mod p).
    inline constexpr gfP xiTo2PSquaredMinus2Over3 = {0x71930c11d782e155, 0xa6bb947cffbe3323, 0xaa303344d4741444, 0x2c3b3f0d26594943};

    // xiToPSquaredMinus1Over6 is ξ^((1p²-1)/6) where ξ = i+9 (a cubic root of -1, mod p).
    inline constexpr gfP xiToPSquaredMinus1Over6 = {0xca8d800500fa1bf2, 0xf0c5d61468b39769, 0x0e201271ad0d4418, 0x04290f65bad856e6};

    // xiTo2PMinus2Over3 is ξ^((2p-2)/3) where ξ = i+9.
    inline constexpr gfP2 xiTo2PMinus2Over3 = {
